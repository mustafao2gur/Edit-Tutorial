...
const EditTutorial = ({ getTutorials, item}) => {
  ...
  //? c. bana stateler gerekceği için şimdiden stateleri tanımlıyorum.bu stateler yeni girilecek olan değerler.
...
//? n. aldığımız uyarı ile input a value verice kontrol etmek istiyoruz. value ve onChange kullanınca kontrollü hale çeviriyoruz. value undefined dan defined e galdi. ilk değerimiz boş geliyor undefined geliyor. o yüzden böyle bir hata veriyor. çözümü  || ""
